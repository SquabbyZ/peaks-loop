...
- The peaks-solo SKILL.md body beyond the new Step 0.55 section. Slice 3 only adds the new section + reference file.
...
- `skills/peaks-solo/SKILL.md` (already ships) — Slice 3 adds Step 0.55 between Step 0.5 and Step 0.7
