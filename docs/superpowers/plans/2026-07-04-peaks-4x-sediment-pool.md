...
| §2 Goals (pool, on-demand load, vendor-neutral, zero-CLI-cost, promotion ladder, peaks-code demoted) | Tasks 1-5 (pool), 6-8 (adapter), 10 (skill), 11-14 (SkillHub), 15 (CLI) |
