...
skills/bee/peaks-rd/SKILL.md                  (Phase 5: v2 slice reading + handoff frontmatter writing)
skills/bee/peaks-qa/SKILL.md                  (Phase 5: handoff frontmatter reading)
skills/bee/peaks-prd/SKILL.md                 (Phase 5: multi-pass AC reference)
skills/bee/peaks-sc/SKILL.md                  (Phase 5: reference peaks-slice-decompose)
