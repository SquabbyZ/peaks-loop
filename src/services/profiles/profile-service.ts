  ...
  return [
    {
      name: 'refactor-guard',
      description:
        'Soft gate profile for refactor coverage, slice spec, artifact retention, and commit boundaries.',
      capabilities: ['refactor-coverage-gate', 'refactor-slice-spec', 'artifact-retention']
    },
    {
      name: 'strict-refactor',
      description:
        'Strict profile that can enable CLI-managed hooks, agents, and artifact repository checks after approval.',
