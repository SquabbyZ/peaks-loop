 ...
 * bypass). The hook runs `peaks solo gate-step-08 --project .` before
 ...
 * `peaks solo detect-job`. The regex is a safety net for the v3.1.1
 ...
 * having skipped `peaks solo detect-job` and the gate blocks.
 *
 ...
 * `src/cli/commands/solo-commands.ts` reads `allow` to set the process
