  ...
  if (!isWorkflowMode(options.mode)) {
    printResult(
      ...
      fail(
        ...
        `Unsupported workflow mode ${options.mode}`,
        {},
...
async function runAutonomousResumeInit(
  io: ProgramIO,
