...
import {
  registerClassifyCommands,
  registerContractCommands
} from './governance-classify-contract-commands.js';
...
const NON_AUTO: ReadonlySet<string> = new Set([
  'core-artifact-commands',
  'capability-worker-config-sc-commands',
  'sub-agent-commands',
  'workspace-commands',
  'workflow-commands',
  'sop-commands',
...
const REGISTRATIONS: readonly Registration[] = [
  ...
  ['codegraph-commands', registerCodegraphCommands],
  ['openspec-commands', registerOpenSpecCommands],
  ['perf-commands', registerPerfCommands],
  ['preferences-commands', registerPreferencesCommands],
  ['project-commands', registerProjectCommands],
  ['prd-commands', registerPrdCommands],
  ['request-commands', registerRequestCommands],
  ['retrospective-commands', registerRetrospectiveCommands],
  ['scan-commands', registerScanCommands],
  ['shadcn-commands', registerShadcnCommands],
  ...
  ['sop-commands', registerSopCommands],
  ['feedback-commands', registerFeedbackCommands],
  ['fork-commands', registerForkCommands],
  ['impact-commands', registerImpactCommands],
  ['smoke-commands', registerSmokeCommands],
  ['release-commands', registerReleaseCommands],
  ['changeset-commands', registerChangesetCommands],
  ['prd-blocks-commands', registerPrdBlocksCommands],
  ['user-touchpoint-commands', registerUserTouchpointCommands],
  ['slice-review-commands', registerSliceReviewCommands],
  ['qa-business-review-commands', registerQaBusinessReviewCommands],
  ['slice-integrate-commands', registerSliceIntegrateCommands],
  ['doc-commands', registerDocCommands],
  ['legacy-commands', registerLegacyCommands],
  ['lint-commands', registerLintCommands],
  ['role-commands', registerRoleCommands],
  ['complexity-commands', registerComplexityCommands],
  ['sub-agent-commands', registerSubAgentCommands],
  ['sub-agent-shutdown-commands', registerSubAgentShutdownCommands],
  ['e2e-verify', registerE2EVerifyCommand],
  ['governance-classify-contract-commands', registerContractCommands],
  ['sub-agent-dispatch-guard', registerSubAgentDispatchGuard],
  ['gate-commands', registerGateCommands],
  ['hook-handle', registerHookHandleCommand],
  ['hooks-commands', registerHooksCommands],
  ['heartbeat-commands', registerHeartbeatCommands],
  ['statusline-commands', registerStatusLineCommands],
  ['workspace-commands', registerWorkspaceCommands],
  ['workflow-plan-commands', registerWorkflowPlanCommands],
  ['audit-commands', registerAuditCommands],
  ['final-review-commands', registerFinalReviewCommands],
  ['governance-classify-contract-commands', registerClassifyCommands],
  ['context-commands', registerContextCommands],
  ...
  ['loop-commands', registerLoopCommands],
  ['loop-eval-commands', registerWorkflowEvalCommands],
  ['evolution-commands', registerEvolutionCommands],
  ['asset-commands', registerAssetCommands],
  ...
  ['log-commands', registerLogCommands],
  ['qa-commands', registerQaCommands],
  ['test-commands', registerTestCommands],
  ['playwright-commands', registerPlaywrightCommands],
  ['code-commands', registerCodeCommands],
  ['code-gate-command', registerCodeGateCommand],
  ['dashboard-commands', registerDashboardCommands],
  ['best-practice-scan-command', registerBestPracticeScanCommand],
  ['mut-commands', registerMutCommands],
  ['fixture-commands', registerFixtureCommands],
  ['reviewer-commands', registerReviewerCommands],
  ['ide-commands', registerIdeCommands],
  ...
  ['adapter-commands-s2a', registerAdapterS2ACommands],
  ['polyrepo-commands', registerPolyrepoCommands],
