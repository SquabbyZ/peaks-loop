...
<p align="center">
  <video src="./examples/video-demo/preview/peaks-loop-demo-en.mp4" controls muted playsinline preload="metadata" width="100%" style="border-radius: 12px; box-shadow: 0 12px 40px rgba(0,0,0,0.55);"></video>
</p>
