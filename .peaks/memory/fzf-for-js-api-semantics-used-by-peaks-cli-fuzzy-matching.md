---
name: fzf-for-js-api-semantics-used-by-peaks-cli-fuzzy-matching
description: fzf-for-js API semantics (used by peaks-cli fuzzy-matching)
metadata:
  type: reference
...
- Zero runtime deps. BSD-3-Clause license. Latest version at time of writing: 0.5.2 (~70KB unpacked). Used by `src/services/fuzzy-matching/fuzzy-match-service.ts` (peaks-cli).
