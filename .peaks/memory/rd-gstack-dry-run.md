---
name: rd-gstack-dry-run
description: Integrate gstack deeply into skills/ content and require repeated peaks-rd dry-runs during code output.
metadata:
  type: feedback
---
...
**How to apply:** When editing or using project skills, align their workflow guidance with gstack concepts where relevant. For peaks-rd code-output workflows, require applicable dry-run checks at preflight, after meaningful implementation changes, and before handoff.
