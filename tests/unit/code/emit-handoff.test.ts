/**
 * v3.1.2 Step 11 — `peaks code emit-handoff` size-fear ban unit tests.
 *
...
import { evaluateEmitHandoff, JOB_NOT_INITIALIZED, JOB_REMAINING_BLOCKED } from '../../../src/services/code/emit-handoff.js';
...
describe('code/emit-handoff: 4 paths', () => {
  let project: string;
  beforeEach(() => {
    project = makeProject();
  });
