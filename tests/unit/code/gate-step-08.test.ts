/**
 * v3.1.2 Step 0.8 — `peaks code gate-step-08` unit tests.
 *
...
import {
  ...
  type Step08Verdict
} from '../../../src/services/code/step-08-gate.js';
...
describe('code/step-08-gate: evaluateStep08 — 4 paths', () => {
  let project: string;
  beforeEach(() => {
    project = makeProject();
  });
...
describe('code/step-08-gate: Next: slice context injection', () => {
  let project: string;
  beforeEach(() => {
    project = makeProject();
  });
...
describe('code/step-08-gate: backup regex shape (sanity)', () => {
...
describe('code/step-08-gate: prompt source fallback', () => {
  let project: string;
  beforeEach(() => {
    project = makeProject();
  });
