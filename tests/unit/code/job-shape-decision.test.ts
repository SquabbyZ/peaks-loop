...
} from '../../../src/services/code/job-shape-decision.js';
...
describe('code/job-shape-decision: validateJobShapeDecision', () => {
...
describe('code/job-shape-decision: writeJobShapeDecision stamping', () => {
  let project: string;
  beforeEach(() => {
    project = makeProject();
  });
...
describe('code/job-shape-decision: writeJobShapeDecision force semantics', () => {
  let project: string;
  beforeEach(() => {
    project = makeProject();
  });
...
describe('code/job-shape-decision: readJobShapeDecision error paths', () => {
  let project: string;
  beforeEach(() => {
    project = makeProject();
  });
...
describe('code/job-shape-decision: round-trip + promptHash', () => {
  let project: string;
  beforeEach(() => {
    project = makeProject();
  });
