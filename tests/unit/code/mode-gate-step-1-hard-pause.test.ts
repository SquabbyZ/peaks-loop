/**
 * Slice 2026-06-28-code-mode-bypass-fix (defect #1).
 *
...
import { shouldPauseAtGate } from '../../../src/services/code/mode-gate.js';

describe('mode-gate — slice 2026-06-28-code-mode-bypass-fix', () => {
